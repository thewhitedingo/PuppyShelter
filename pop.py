...
from pupdb import Base, Shelter, Puppy, Adopter
...
#Add Shelters
shelter1 = Shelter(name = "Oakland Animal Services", address = "1101 29th Ave", city = "Oakland", state = "California", zipCode = "94601", website = "oaklandanimalservices.org", maximum_capacity = 22)
...
shelter3 = Shelter(name = "Wonder Dog Rescue", address= "2926 16th Street", city = "San Francisco", state = "California" , zipCode = "94103", website = "http://wonderdogrescue.org", maximum_capacity = 22)
session.add(shelter3)

shelter4 = Shelter(name = "Humane Society of Alameda", address = "PO Box 1571" ,city = "Alameda" ,state = "California", zipCode = "94501", website = "hsalameda.org", maximum_capacity = 22)
session.add(shelter4)

shelter5 = Shelter(name = "Palo Alto Humane Society" ,address = "1149 Chestnut St." ,city = "Menlo Park", state = "California" ,zipCode = "94025", website = "paloaltohumane.org", maximum_capacity = 22)
...
def add_adopter(name, address, city, state, zipCode, phone):
    adopter = Adopter(name = name, address = address, city = city, state = state, zipCode = zipCode, phone = phone)
    session.add(adopter)
    session.commit()

add_adopter('Jim', "200 16th Street", "San Francisco", "California", 94013, '1234567')